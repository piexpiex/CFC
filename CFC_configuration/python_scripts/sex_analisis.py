...
if Z[4]>=0.98:
	...
	c22 = fits.Column(name='Ellipticity',array=final_objects[:,ELLIPTICITY], format='E')
	c23 = fits.Column(name='FWHM', unit='arcsec',array=3600*final_objects[:,FWHM_WORLD], format='E')
	...
	c13 = fits.Column(name='MAG',array=Z[1]+Z[0]*total_objects[:,17], format='E')
	c14 = fits.Column(name='e_MAG',array=(abs(e_B)**2+abs(e_A*total_objects[:,17])**2+abs(Z[0]*total_objects[:,18])**2)**0.5, format='E')
	c15 = fits.Column(name='MAG_sex',array=total_objects[:,MAG_PSF], format='E')
	c16 = fits.Column(name='e_MAG_sex',array=total_objects[:,MAGERR_PSF], format='E')
	...
	c19 = fits.Column(name='Elongation',array=total_objects[:,ELONGATION], format='E')
	c20 = fits.Column(name='Ellipticity',array=final_objects[:,ELLIPTICITY], format='E')
	c21 = fits.Column(name='FWHM', unit='arcsec',array=3600*total_objects[:,FWHM_WORLD], format='E')
