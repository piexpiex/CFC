...
#images_table.write('#Number of sources,-->,Number of sources used for the calibration\n')
#images_table.write('#Reference catalog,-->,Catalog used to calibrate magnitudes, it can be SDSS or APASS\n')
...
#images_table.write('#B,-->,Slope of the calibration curve\n')
#images_table.write('#e_B,-->,Uncertainty of the slope of the calibration curve\n')
...
#images_table.write('#Reason,-->,Reason for the rejection of the catalog, if the status is calibrated the box will be empty\n')

images_table.write('Image name' +','+'number of sources'+','+ 'Reference catalog' +','+ 'A (mag)' +','+ 'e_A (mag)' +','+   'B' +','+'e_B'+','+   'r' +','+  'status'+','+ 'Reason'+ '\n'+'\n'+'\n')
